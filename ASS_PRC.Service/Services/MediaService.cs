...
namespace ASS_PRC.Services.Services
{
    public class MediaService : IMediaService
    {
        ...
        public async Task<bool> PostMedia(string MediaName, string Url, string ImaUrl, string Author, string Singer, int Type, List<Guid> Category, Guid UserId, Guid PlaylistID, string FileName)
        {
        ...
        public async Task<bool> DeleteMediaWebAdmin(Guid MediaId)
        {
        ...
        public async Task<string> PutMedia(Guid MediaId,string MediaName, string Url, string ImaUrl, string Author, string Singer, int Type, List<Guid> Category, Guid UserId, string FileName)
        {
