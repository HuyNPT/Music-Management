...
namespace ASS_PRC.Services.Services
{
    public interface IMediaService
    {
        ...
        Task<bool> PostMedia(string MediaName, string Url, string ImaUrl, string Author, string Singer, int Type, List<Guid> Category, Guid UserId, Guid PlaylistID,string FileName);
        Task<bool> DeleteMediaWebAdmin(Guid MediaId);

        Task<int> GetMediaCount();
        Task<string> PutMedia(Guid MediaId,string MediaName, string Url, string ImaUrl, string Author, string Singer, int Type, List<Guid> Category, Guid UserId, string FileName);
